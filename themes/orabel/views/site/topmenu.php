...
<div class="orb-page-frame orb-home-1">
          ...
          <nav>
            <ul class="orb-menu">
              ...
              <li class="orb-has-children">
                <a href="about-1.html">درباره من</a>
                <ul>
                  <li><a href="about-1.html">نوع 1</a></li>
                  <li><a href="about-2.html">نوع 2</a></li>
                  <li><a href="about-3.html">نوع 3</a></li>
                </ul>
              </li>
              <li class="orb-has-children">
                <a href="portfolio-1.html">نمونه کارها</a>
                <ul>
                  <li><a href="portfolio-1.html">نوع 1</a></li>
                  <li><a href="portfolio-2.html">نوع 2</a></li>
                  <li><a href="portfolio-3.html">نوع 3</a></li>
                  <li><a href="portfolio-4.html">نوع 4</a></li>
                  <li><a href="portfolio-5.html">نوع 5</a></li>
                </ul>
              </li>
              <li class="orb-has-children">
                <a href="blog-1.html">وبلاگ</a>
                <ul>
                  <li><a href="blog-1.html">نوع 1</a></li>
                  <li><a href="blog-2.html">نوع 2</a></li>
                  <li><a href="blog-3.html">لیست کلاسیک</a></li>
                  <li><a href="blog-4.html">منتشر شده</a></li>
                </ul>
              </li>
              <li class="orb-has-children">
                <a href="contact-1.html">تماس</a>
                <ul>
                  <li><a href="contact-1.html">نوع 1</a></li>
                  <li><a href="contact-2.html">نوع 2</a></li>
                  <li><a href="contact-3.html">نوع 3</a></li>
                </ul>
              </li>
            </ul>
          </nav>
  ...
  <div class="orb-content" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
            ...
            <div class="swiper-container orb-slideshow">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="img/photo/30.jpg" alt="عکس" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" />
                </div>
                <div class="swiper-slide">
                  <img src="img/photo/20.jpg" alt="عکس" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" />
                </div>
                <div class="swiper-slide">
                  <img src="img/photo/23.jpg" alt="عکس" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" />
                </div>
                <div class="swiper-slide">
                  <img src="img/photo/31.jpg" alt="عکس" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" />
                </div>
                <div class="swiper-slide">
                  <img src="img/photo/32.jpg" alt="عکس" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" />
                </div>
                <div class="swiper-slide">
                  <img src="img/photo/33.jpg" alt="عکس" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="orb-navigation">
      ...
      <a href="portfolio-1.html" class="orb-button">
        <div class="orb-arrow"><img src="img/ui/arrow-1.svg" alt="فلش" /></div>
        <span>
          نمایش <br />
          نمونه کارها
        </span>
